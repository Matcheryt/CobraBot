...
namespace CobraBot.Modules
{
    ...
    public class InfoModule : ModuleBase<SocketCommandContext>
    {
        ...
        [Alias("serverinfo")]
        [Name("Server info")]
        [Summary("Shows current server info.")]
        ...
        [Command("user")]
        [Alias("whois", "usinfo", "userinfo")]
        [Name("User info")]
        [Summary("Shows discord info for specified user.")]
        ...
        //Shows uptime
        [Command("botinfo")]
        [Alias("info", "binfo", "cobra", "uptime")]
        [Name("Bot Info")]
        [Summary("Shows Cobra's information.")]
        ...
        [Command("invite")]
        [Name("Invite")]
        [Summary("Shows a link to invite Cobra to your server.")]
