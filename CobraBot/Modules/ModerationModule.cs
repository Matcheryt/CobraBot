...
namespace CobraBot.Modules
{
    ...
    public class ModerationModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task BanUser([CanModerateUser] IUser user, [Name("prune days")] int pruneDays = 0,
        ...
        [RequireUserPermission(GuildPermission.MuteMembers)]
        [Name("Unmute voice")]
        [Summary("Removes voice mute from specified user.")]
        [Command("unvmute")]
        ...
        [Name("Clean")]
        [Summary("Deletes 'count' messages from the chat.")]
        ...
        [Name("Slowmode")]
        [Summary(
            "Sets specified channel slowmode to specified interval. If no interval is specified, the command will reset the channel's slowmode to 0.")]
        ...
        [Command("role")]
        [Name("Role")]
        [Summary("Adds/removes role from specified user. Operation + adds role, - removes role.")]
        ...
        [Ratelimit(1, 2, Measure.Seconds)]
        [Name("Lookup")]
        [Summary("Searches for mod case that matches specified case ID")]
