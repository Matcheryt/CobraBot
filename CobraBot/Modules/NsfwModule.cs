...
namespace CobraBot.Modules
{
    ...
    public class NsfwModule : ModuleBase<SocketCommandContext>
    {
        [Command("nsfw")]
        [Name("NSFW")]
        [Summary("Shows random NSFW image (real life stuff).")]
        ...
        [Command("nsfw gif")]
        [Name("NSFW gif")]
        [Summary("Shows random NSFW gif (real life stuff).")]
        ...
        [Name("NSFW Subreddit")]
        [Summary(
            "Shows a random post from specified NSFW subreddit. Span can be `hour`, `day`, `week`, `month`, `year` and `all`. Default: `day`")]
        ...
        [Command("hentai")]
        [Name("Hentai")]
        [Summary("Shows a random hentai image.")]
        ...
        [Command("hentai gif")]
        [Name("Hentai gif")]
        [Summary("Shows a random hentai gif.")]
        ...
        [Command("neko")]
        [Name("Neko")]
        [Summary("Shows a random neko image.")]
        ...
        [Command("ass")]
        [Name("Ass")]
        [Summary("Shows a random ass image.")]
