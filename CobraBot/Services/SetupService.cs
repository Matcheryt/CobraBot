...
namespace CobraBot.Services
{
    ...
    public sealed class SetupService
    {
        ...
        /// <summary>
        ///     Updates welcome channel in database. If no ITextChannel is specified, the welcome channel for the specified
        ///     guild will be reset.
        /// </summary>
        /// <param name="context"> The command context. </param>
        ...
        public async Task ChangeWelcomeChannel(SocketCommandContext context, ITextChannel textChannel = null)
        {
            ...
            guildSettings.WelcomeChannel = textChannel?.Id ?? 0;
        ...
        /// <summary>
        ///     Updates moderation channel in database. If no ITextChannel is specified, the moderation channel for the
        ///     specified guild will be reset.
        /// </summary>
        /// <param name="context"> The command context. </param>
        ...
        public async Task ChangeModerationChannel(SocketCommandContext context, ITextChannel textChannel = null)
        {
            ...
            guildSettings.ModerationChannel = textChannel?.Id ?? 0;
        ...
        /// <summary>
        ///     Updates role on join in database. If no IRole is specified, the role on join for the specified guild will be
        ///     reset.
        /// </summary>
        /// <param name="context"> The command context. </param>
        ...
        public async Task ChangeRoleOnJoin(SocketCommandContext context, IRole role = null)
        {
            ...
            guildSettings.RoleOnJoin = role?.Id ?? 0;
        ...
        private async Task PrefixSetup(SocketCommandContext context)
        {
            ...
            if (nextMessageResult.IsSuccess)
            {
                await nextMessageResult.Value.DeleteAsync();
                await tmpMessage.DeleteAsync();
                await context.Channel.SendMessageAsync(embed: await ChangePrefix(context,
                    nextMessageResult.Value.Content));
            }
        }
